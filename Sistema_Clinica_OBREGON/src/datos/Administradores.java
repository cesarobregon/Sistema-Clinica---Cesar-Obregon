...
public class Administradores extends Conexion{
    ...
    public boolean isNew(Object o) {
        ...
        try {
            ...
            rs.updateString("usuario", adm.getUsuario());
            rs.updateString("clave", adm.getClave());
    ...
    /**
     * Metodo que recibe como parametro un Objeto tipo Especialidad y lo
     * ACTUALIZA en la base de datos en la tabla especialidades
     *
     * @param o
     * @return true=registra, false=presencia de error
     */
    ...
    public boolean isUpdate(Object o) {
        ...
        try {
            ...
            ResultSet rs = st.executeQuery("SELECT * FROM " + getTabla() + " WHERE id=" + adm.getId());
    ...
    /**
     * Metodo que recibe como parametro un Objeto tipo Especialidad y lo BORRA
     * en la base de datos en la tabla especialidades
     *
     * @param l
     * @return true=registra, false=presencia de error
     */
     ...
     * Especialidad, sino encuentra la especialidad el Objeto que retorna es
     * nulo (null)
     *
     * @param id
     * @return Location
